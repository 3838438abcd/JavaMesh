...
```yaml
concurrency:
  group: ${{ github.workflow }}-${{ github.head_ref || github.event.pull_request.number }}-${{ github.ref }}
...
- `push` event, the commits. This event triggers existing workflows by default, regardless of branches and paths.
