...
public class RetryInjectDefine implements ClassInjectDefine {
    private final String restTemplateClass = "org.springframework.web.client.RestTemplate";
    @Override
    ...
    private boolean isLoadedClass() {
        ...
        return ClassUtils.loadClass(restTemplateClass, contextClassLoader).isPresent();
    }
}
