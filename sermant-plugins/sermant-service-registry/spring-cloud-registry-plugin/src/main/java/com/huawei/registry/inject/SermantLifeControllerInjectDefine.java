 ...
 * @since 2022-05-17
 */
public class SermantLifeControllerInjectDefine implements ClassInjectDefine {
    @Override
    public String injectClassName() {
        return "com.huawei.registry.inject.grace.SermantLifeController";
    }
    ...
    public boolean canInject() {
        ...
        return pluginConfig.isEnableSpring() && pluginConfig.isEnableHealthCheck();
    }
